...
void initGL() {
    glClearColor(0.0f, 1.0f, 1.5f, 1.0f);
    glClearDepth(1.0f);
...
static void functions() {
    ...
    if (user_input[0] == '/') {
        ...
        if (user_input == "/check") {
            ...
            cout << "Cube Rubik is " << s << ".\n";
        } else if (user_input == "/print") {
            cube.print();
        } else if (user_input == "/random set") {
            increment *= 10;
            random = true;
            ...
            string path = "C:/Users/GMaks/Документы/CubeRubik";
            if (command == "/save") {
